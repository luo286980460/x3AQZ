...
namespace LedSDKDemo_CSharp
{
    ...
    class Dynamic_5
    {
        ...
        public static void updata_dynamic_txt()
        {
            ...
            oFont.color = 1;
            oFont.fontBold = 0;
            oFont.fontItalic = 0; oFont.tdirection = bxdualsdk.E_txtDirection.pNORMAL; oFont.txtSpace = 0; oFont.Halign = 1; oFont.Valign = 1;
            ...
            if (Program.check)
            {
                err = bxdualsdk.bxDual_dynamicArea_AddAreaWithTxt_5G(Program.ip, Program.port, bxdualsdk.E_ScreenColor_G56.eSCREEN_COLOR_SINGLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
