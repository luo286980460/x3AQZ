...
namespace LedSDKDemo_CSharp
{
    ...
    class Program_Send_time
    {
        ...
        public static void Send_program_time_5()
        {
            ...
            bxdualsdk.EQtimeAreaData_G56 timeData1;
            timeData1.linestyle = bxdualsdk.E_arrMode.eMULTILINE;
            timeData1.color = (uint)bxdualsdk.E_Color_G56.eRED;
            ...
            timeData1.datestyle = bxdualsdk.E_DateStyle.eYYYY_MM_DD_MINUS;
            timeData1.time_enable = 0;
            timeData1.timestyle = bxdualsdk.E_TimeStyle.eHH_MM_AM;
            timeData1.week_enable = 0;
            timeData1.weekstyle = bxdualsdk.E_WeekStyle.eMonday_CHS;
        ...
        public static void Send_program_time_6()
        {
            ...
            if (false)
            {
                bxdualsdk.BXG6_Time_Counter Battle = new bxdualsdk.BXG6_Time_Counter();
        ...
        public static void Send_program_battieTime_6()
        {
            ...
            bxdualsdk.EQTimeAreaBattle_G6 timebattie = new bxdualsdk.EQTimeAreaBattle_G6();
            ...
            err = bxdualsdk.bxDual_cmd_battieTime(Program.ip, Program.port, 0, ref Battle);
        }
    }
}
