...
namespace LedSDKDemo_CSharp
{
    public class common_56
    {
        ...
        public static void Net_Bright( byte num)
        {
            ...
            {
                err = bxdualsdk.bxDual_cmd_setBrightness_uart(Program.com, Program.baudRate, ref brightness);
            }
        ...
        { 
            ...
            {
                err = bxdualsdk.bxDual_cmd_coerceOnOff_uart(Program.com, Program.baudRate, 0);//关机
                err = bxdualsdk.bxDual_cmd_coerceOnOff_uart(Program.com, Program.baudRate, 1);//开机
            }
        }
        //定时开关机
        ...
        {           
            ...
            {
                err = bxdualsdk.bxDual_cmd_check_time_uart(Program.com, Program.baudRate);
            }
        }
        /// <summary>
        /// 读控制器ID
        ...
        public static void confStartReedFile()
        {
            ...
            else
            {
                ...
                //Marshal.FreeHGlobal(dec);
                bxdualsdk.ConfigFile_G6 configData = new bxdualsdk.ConfigFile_G6();
        ...
        public static void sendConfigFile()
        {
            ...
            err = bxdualsdk.bxDual_cmd_confStartReedFile(Program.ip, Program.port, fileName, ref fileLen,ref fileCrc);
            byte[] configData = new byte[1024];
            err = bxdualsdk.bxDual_cmd_confReedFileBlock(Program.ip, Program.port, fileName, configData);

            IntPtr dec = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(bxdualsdk.ConfigFile_G6)));
            Marshal.Copy(configData, 0, dec, Marshal.SizeOf(typeof(bxdualsdk.ConfigFile_G6)));
            bxdualsdk.ConfigFile_G6 data = (bxdualsdk.ConfigFile_G6)Marshal.PtrToStructure(dec, typeof(bxdualsdk.ConfigFile_G6));
            Marshal.FreeHGlobal(dec);

            err = bxdualsdk.bxDual_cmd_sendConfigFile_G6(Program.ip, Program.port, ref data);
