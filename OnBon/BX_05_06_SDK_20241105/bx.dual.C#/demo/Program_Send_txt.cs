...
namespace LedSDKDemo_CSharp
{
    ...
    class Program_Send_txt
    {
        ...
        public static void Send_program_txt_6()
        {
            ...
            //第一步.设置屏幕参数相关  发送节目必要接口，发送动态区可忽略
            err = bxdualsdk.bxDual_program_setScreenParams_G56((bxdualsdk.E_ScreenColor_G56)cmb_ping_Color, data.ControllerType, bxdualsdk.E_DoubleColorPixel_G56.eDOUBLE_COLOR_PIXTYPE_2);
            //err = bxdualsdk.bxDual_program_setScreenParams_G56((bxdualsdk.E_ScreenColor_G56)2, 0x4262, bxdualsdk.E_DoubleColorPixel_G56.eDOUBLE_COLOR_PIXTYPE_2);
            ...
            byte[] strAreaTxtContent = Encoding.GetEncoding("GBK").GetBytes("测试状态文本1\0");
        ...
        public static void Send_program_txt_6_1()
        {
            ...
            pheader1.arrMode = bxdualsdk.E_arrMode.eMULTILINE;
            ...
            bxdualsdk.EQpageHeader_G6 pheader2;
            ...
            pheader2.arrMode = bxdualsdk.E_arrMode.eSINGLELINE;
            pheader2.fontSize = 12;
            pheader2.color = (uint)0x01;
            pheader2.fontBold = 0;
            pheader2.fontItalic = 0;
            pheader2.tdirection = bxdualsdk.E_txtDirection.pNORMAL;
            pheader2.txtSpace = 0;
            pheader2.Valign = 2;
            pheader2.Halign = 2;
            ...
            program = new bxdualsdk.EQprogram_G6();
            err = bxdualsdk.bxDual_program_IntegrateProgramFile_G6(ref program);
            Console.WriteLine("bxDual_program_IntegrateProgramFile_G6:" + err);
