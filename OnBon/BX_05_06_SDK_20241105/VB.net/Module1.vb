...
Module Module1
    ...
    Public Sub Creat_AddStr_6()
        ...
        AreaText = "123"
        str = code.GetBytes(AreaText)
        AreaText = "C:\Windows\Fonts\tahoma.ttf"
        font = code.GetBytes(AreaText)
        Dim pheader As Ledsdk.EQpageHeader_G6
        pheader.PageStyle = &H0
        pheader.DisplayMode = &H1
        pheader.ClearMode = &H1
        pheader.Speed = 10
        pheader.StayTime = 500
        pheader.RepeatTime = 1
        ...
        err = Ledsdk.bxDual_program_fontPath_picturesAreaAddTxt_G6(0, str, font, pheader)
    ...
    Public Sub dynamic_6()
        ...
        'err = Ledsdk.bxDual_dynamicArea_AddAreaInfos_6G_V2(ip, 5005, Ledsdk.E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, 0, 0, 10, 0, 0, RelateProSerial, 1,
    ...
    Public Sub dynamicArea_str_1()
        ...
        AreaText = "宋体"
        font = code.GetBytes(AreaText)
        err = Ledsdk.bxDual_dynamicArea_AddAreaTxt_6G(ip, 5005, Ledsdk.E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, 0, 0, 0, 64, 32, font, 12, str)
    End Sub

    Public Sub dynamicArea_str_2()
        Dim err As Integer
        Dim AreaText As String
        Dim code As Encoding = Encoding.GetEncoding("gb2312")
        Dim ip() As Byte
        AreaText = "192.168.89.184"
        ip = code.GetBytes(AreaText)
        Dim str(), font() As Byte
        AreaText = "Hello,123"
        str = code.GetBytes(AreaText)
        ...
        Dim RelateProSerial() As UShort
        RelateProSerial = {0, 0}
        'err = Ledsdk.bxDual_dynamicArea_AddAreaTxtDetails_6G(ip, 5005, BX_dualSDK.E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, 0, aheader, pheader, font, str)
        err = Ledsdk.bxDual_dynamicArea_AddAreaTxtDetails_WithProgram_6G(ip, 5005, Ledsdk.E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, 0, aheader, pheader, font, str, 0, RelateProSerial)
    End Sub
End Module
