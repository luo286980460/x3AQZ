...
Public Class Ledsdk
    ...
    Public Enum E_Color As UInteger
        ...
        eYELLOW    '黄色
    End Enum
    Public Enum E_txtDirection As Byte
        pNORMAL       '正常
        pROTATERIGHT  '向右旋转
        pMIRROR       '镜像
        pROTATELEFT   '向左旋转
    ...
    Public Declare Auto Function bxDual_program_fontPath_picturesAreaAddTxt_G6 Lib "bx_sdk_dual.dll" (ByVal areaID As UShort, ByVal str() As Byte, ByVal fontName() As Byte, ByRef programH As EQpageHeader_G6) As Integer
    '添加图片
    ...
    Public Declare Auto Function bxDual_dynamicArea_AddAreaTxt_6G Lib "bx_sdk_dual.dll" (ByVal ip() As Byte, ByVal port As UShort, ByVal color As E_ScreenColor_G56, ByVal uAreaId As Byte,
            ByVal uAreaX As UShort,
            ByVal uAreaY As UShort,
            ByVal uWidth As UShort,
            ByVal uHeight As UShort,
            ByVal fontName() As Byte, ByVal nFontSize As Byte, ByVal str() As Byte) As Integer

    Public Declare Auto Function bxDual_dynamicArea_AddAreaTxtDetails_6G Lib "bx_sdk_dual.dll" (ByVal ip() As Byte, ByVal port As UShort, ByVal color As E_ScreenColor_G56,
            ByVal uAreaId As Byte, ByRef oAreaHeader_G6 As EQareaHeader_G6,
            ByRef pheader As EQpageHeader_G6, ByVal fontName() As Byte, ByVal str() As Byte) As Integer

    Public Declare Auto Function bxDual_dynamicArea_AddAreaTxtDetails_WithProgram_6G Lib "bx_sdk_dual.dll" (ByVal ip() As Byte, ByVal port As UShort, ByVal color As E_ScreenColor_G56,
            ByVal uAreaId As Byte, ByRef oAreaHeader_G6 As EQareaHeader_G6,
            ByRef pheader As EQpageHeader_G6, ByVal fontName() As Byte, ByVal str() As Byte,
            ByVal RelateProNum As Byte,
            ByVal RelateProSerial() As UShort) As Integer
End Class
